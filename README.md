...
YOLOv8을 활용한 실시간 나루토 인(Hand Seal) 인식 및 VFX 발동 프로그램
## 📌 Project Overview
카메라로 인(Hand Seal)을 맺으면 AI가 이를 실시간으로 인식하여 화면에 화려한 인술 이펙트를 띄워주는 프로젝트입니다. 

객체 인식 파이프라인을 구축하고, 인터랙티브한 시각 효과를 구현하는 것을 목표로 합니다. 
## ✨ Key Features
...
git clone https://github.com/chaennchae/copy-ninja-bakakashi.git
